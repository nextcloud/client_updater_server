	...
	'Nextcloud' => [
		'stable' => [
			...
			'macos' => [
				...
				"signature" => "PTotG57+4/3uH/hiP6+MEPZAsNQPFPF8Pls7pQay9zDJqZPVbHCF3hHf8ZOxvxFRSrFjRBXfgRDpBKjBmSPKAw==",
				"length" => 63477087
			],
		],
		'beta' => [
			...
			'macos' => [
				...
				"signature" => "CCSTuWpWuwA0+gqHJuGNmCP5SWkPOnZjbimMNRvHHCd/8P/cS9D9inZyX41ezc+vw1y4IHVMQfAY2fj/z6FwCQ==",
				"length" => 63714790
			],
		]
	]
