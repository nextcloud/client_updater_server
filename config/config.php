...
// daily
//
$dailyReleaseDateLinux = '20260715';
$dailyReleaseDateWindows = '20260716';
$dailyReleaseDateMacos = '20260707';

//
// beta
// should point to stable, once stable is released
//
$betaReleaseDate = '2026-07-15 11:00';
$betaVersionInternal = '33.0.82'; // short string
$betaVersion = '34.0.0-rc2'; // long string like '3.16.0-rc3' used to hide the cryptical subversion like .58 from the user;
$betaVersionSignature = '4FFGTAVwhkf2BNmiako1y89+QNihuc16bPbZp6mOR9jTxBJeOwfIO0ur2luDJGmaegp5tiNrdNZ78MlxNm6xAQ==';
$betaVersionLength = 147678494;
...
// stable
//
$stableReleaseDate = '2026-06-29 14:00';
$stableVersion = '33.0.7';
$stableVersionSignature = 'v4L1wtOEPvFmuPuCWZV4WPwWGzNv8f4uTujwoOlmvyHQUmUXLuD5SXxCvpBmBoLO0gFF6Nn0RINesDDwwwBlDQ==';
$stableVersionLength = 350629820;

//
// enterprise 
// should point to that stable version, that was branded to the customers
//
$enterpriseReleaseDate = '2026-07-09 09:00';
$enterpriseVersion = '4.0.11';
$enterpriseVersionSignature = '/yQZsKjL9wyvfWwUzU67z4HlUtCK71FFQRTjsfN01/MuJCnQUzRKREEOlAHRaJAf6qJhMFa4kv1yJt6WpTajCg==';
$enterpriseVersionLength = 343161622;
$enterpriseVersionFileProviderSignature = 'HjAsYmMmlAJTuhCHyddWwjSNQFqiluUoekNNQHcfGrbjIM4vCU9BQOss2KCwzOLgEWevRM4m6mnH46zp4ou4DQ==';
$enterpriseVersionFileProviderLength = 372015653;
